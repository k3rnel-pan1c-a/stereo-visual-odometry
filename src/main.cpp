...
int main(int argc, char** argv) {
    ...
    for (int i = 0; i < total_frames; ++i) {
        ...
        if (i == 0) {
            ...
            cv::Mat stereo_display = makeStereoDisplay(curr_frame.left_img, curr_frame.right_img);
    ...
    std::cout << "\nDone." << std::endl;
    std::cout << "Saved estimated trajectory to: ../outputs/trajectory_est.txt" << std::endl;
    std::cout << "Saved trajectory plot to: ../outputs/trajectory_plot.png" << std::endl;
    std::cout << "Saved stereo match example to: ../outputs/stereo_matches/frame_000000.png" << std::endl;
    std::cout << "Saved temporal match example to: ../outputs/temporal_matches/frame_000000_000001.png" << std::endl;
